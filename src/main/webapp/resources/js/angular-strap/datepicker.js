    ...
    link: function postLink(scope, element, attr, controller) {
      ...
      scope.$watch(attr.ngModel, function(newValue, oldValue) {
        //datepicker.update(controller.$dateValue);
              if (newValue == null) {
                      //we update the datepicker value with the today's date
                      datepicker.update(new Date());
                      //then we erase the displayed value
                      datepicker.$viewValue = null;
                  }
                  else{
                    //Here we keep the default behaviour if the new value isn't null
                    datepicker.update(controller.$dateValue);
                  }
      }, true);
